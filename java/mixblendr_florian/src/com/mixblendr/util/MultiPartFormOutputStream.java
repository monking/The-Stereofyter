...
public class MultiPartFormOutputStream
{
    ...
    /** for file upload, count the number of bytes written */
        ...
        */
        ...
        while(offset < data.length) {
            ...
            if (offset + r > data.length) {
            	r = data.length - offset;
            }
            out.write(data, offset, r);
            bytesWritten += r;
            offset += r;
        }
	...
	/**
	 * return the number of written bytes for an ongoing writeFile() operation.
	 * Each writeFile operation starts at 0. Headers are not counted.
	 */
    ...
    /** abort any ongoing action. writeFile() will likely exit with an exception */ 
